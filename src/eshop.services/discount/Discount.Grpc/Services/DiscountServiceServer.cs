...
public class DiscountServiceServer(DiscountContext dbContext, ILogger<DiscountServiceServer> logger) : DiscountProtoService.DiscountProtoServiceBase
{
    ...
    public override async Task<CouponModel> GetDiscount(GetDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount retrieved for {ProductName}: {Percentage}", coupon.ProductName, coupon.Percentage);
    ...
    public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount created for {ProductName}: {Percentage}", coupon.ProductName, coupon.Percentage);
        return coupon.Adapt<CouponModel>();
    }
    ...
    public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount updated for {ProductName}: {Percentage}", coupon.ProductName, coupon.Percentage);
        return coupon.Adapt<CouponModel>();
    }
