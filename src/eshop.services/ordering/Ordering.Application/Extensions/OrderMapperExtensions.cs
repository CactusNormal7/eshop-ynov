...
public static class OrderMapperExtensions
{
    ...
    public static CreateOrderCommand MapToCreateOrderCommand(BasketCheckoutEvent message)
    {
        ...
        var createOrderDto = new CreateOrderDto(
            ...
            OrderItems:
            [
                new CreateOrderItemDto(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61"), null, 2, 500),
                new CreateOrderItemDto(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914"), null, 1, 400)
            ]);

        return new CreateOrderCommand(createOrderDto);
    }
